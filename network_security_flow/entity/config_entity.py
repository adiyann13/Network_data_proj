...
class DataTransformationConfig:
    def __init__(self , training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_train_file_path:str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSOFRMED_DATA_DIR)
        training_pipeline.TRAIN_FILE_NAME.replace("csv","npy")
        self.transformed_test_file_path:str =os.path.join(self.data_transformation_dir ,training_pipeline.DATA_TRANSFORMATION_TRANSOFRMED_DATA_DIR )
        training_pipeline.TEST_FILE_NAME.replace("csv","npy")
        self.tranformed_object_file_path:str = os.path.join(self.data_transformation_dir , training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, training_pipeline.PRE_PROCESSING_FILE)
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfit_underfuit_threshold:float = training_pipeline.MODEL_TRAINER_OVER_UNDER_FITTING_THRESHOLD
